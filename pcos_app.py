...
if app_step == "overview":
    ...
    steps_data = [
        ...
        ("02", "PCOS Detection",
         "Clinical data is passed through a trained XGBoost pipeline (P1 model) to determine whether PCOS is present or absent, returning a binary result with a confidence score.",
         "Machine Learning · Binary classification", "#f5f0fe", "#5a38b0", "rgba(124,82,204,0.25)"),
